import { type Component, createResource, Show, createSignal, For } from 'solid-js';
            ...
            <div class="flex flex-row gap-2 justify-center py-2">
              ...
              >
                <button
                  ...
                  onClick={() => {
                    setSearchParams({
                      currentPage:
                        Number(((searchParams.currentPage as unknown as number) ?? 0).toString()) -
                        1,
                    });
                  }}
                >
              ...
              <Show
                when={
                  ...
                  Number(membersResult()?.totalCount.toString())
                }
              >
                <button
                  class="rounded cursor-pointer disabled:cursor-default border border-slate-300 stroke-slate-300 hover:stroke-slate-500 hover:border-slate-500"
