        ...
        <div class="w-full sm:grow-0 grow flex flex-col pt-4 pb-6 px-4">
          <div class="flex flex-col gap-2">
            ...
            <select
              class="rounded"
              onChange={(e) => {
                filterGender = e.currentTarget.value;
              }}
            >
              <option value="">全部</option>
              <option value="男" selected={decodeURIComponent(searchParams.filterGender) === '男'}>
                男
              </option>
              <option value="女" selected={decodeURIComponent(searchParams.filterGender) === '女'}>
                女
              </option>
            </select>
          </div>
