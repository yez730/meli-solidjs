import type { Pages, Res } from "../types";

import type { Member, NewMember, Recharge ,Barber, NewBarber, UpdateInfo,Identity, PermissionResponse
...
export async function loginByPassword(account:string,password:string): Promise<Res<Barber>> {
    ...
    let data = await res.json() as Barber;
    return {
        ok:true,
        data
    };
...
export async function getCurrentIdentity() : Promise<Res<Identity>> {
    ...
    let data = await res.json() as Identity;
...
export async function registerMerchant(merchantName:string,accountRealName:string,loginAccount:string,password:string): Promise<Res<Barber>> {
...
export async function getCurrentMerchant(): Promise<Res<Merchant>> {
    ...
    let data = await res.json() as Merchant;
...
export async function getAllPermissions(search:string) : Promise<Res<PermissionResponse>>  {
    ...
    let data = await res.json() as PermissionResponse;
...
export async function getMembers(page:number, pageSize:number, search:string,filterGender:string) : Promise<Pages<Member>>  {
    let searchParams = new URLSearchParams();
...
export async function addMember(member:NewMember):Promise<Res<Member>> {
    ...
    let data = await res.json() as Member;
    return {
        ok:true,
        data,
    }
...
export async function recharge(memberId:string,recharge:Recharge):Promise<Res<boolean>> {
...
export async function getOrdersByMemberId(memberId:string,page:number, pageSize:number) : Promise<Pages<StatisticOrderType>>  {
    let searchParams = new URLSearchParams();
    searchParams.append("pageIndex", page.toString());
    searchParams.append("pageSize", pageSize.toString());
...
export async function getRechargeRecordsByMemberId(memberId:string,page:number, pageSize:number) : Promise<Pages<StatisticRechargeRecordType>>  {
    let searchParams = new URLSearchParams();
    searchParams.append("pageIndex", page.toString());
    searchParams.append("pageSize", pageSize.toString());
...
export async function getServiceTypes(page:number, pageSize:number, search:string) : Promise<Pages<ServiceType>>  {
    let searchParams = new URLSearchParams();
    searchParams.append("pageIndex", page.toString());
    searchParams.append("pageSize", pageSize.toString());
    if (search){
...
export async function addServiceType(serviceType:NewServiceType):Promise<Res<ServiceType>> {
    ...
    let data = await res.json() as ServiceType;
...
export async function updateServiceType(serviceTypeId:string,serviceType:NewServiceType) :Promise<Res<boolean>>   {
    const res = await fetch(`${base}/service_type/${serviceTypeId}`, {
        method: 'POST',
        credentials: 'include',
        headers: {
...
export async function getAppointments(startDate:string, endDate:string,barberId:string) : Promise<Appointment[]>  {
    let searchParams = new URLSearchParams();
...
export async function addAppointment(appointment:NewAppointment):Promise<Res<Appointment>> {
    ...
    let data = await res.json() as Appointment;
...
//statistic-----------------------------------
export async function getOrders(page:number, pageSize:number, search:string) : Promise<Pages<StatisticOrderType>>  {
    let searchParams = new URLSearchParams();
    searchParams.append("pageIndex", page.toString());
    searchParams.append("pageSize", pageSize.toString());
    if (search){
...
export async function getRechargeRecords(page:number, pageSize:number, search:string) : Promise<Pages<StatisticRechargeRecordType>>  {
    let searchParams = new URLSearchParams();
    searchParams.append("pageIndex", page.toString());
    searchParams.append("pageSize", pageSize.toString());
    if (search){
